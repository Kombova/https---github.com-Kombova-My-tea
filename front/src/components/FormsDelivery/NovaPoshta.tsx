...
const NovaPoshta = () =>{
    ...
    return(
        <div id="down" className=" h-[1000px]  mt-[20px] ">
                    <ul className=" max-w-[900px] h-[700px] pl-[20px] pr-[20px] pt-[30px] pb-[30px] mx-auto mt-[20px] flex flex-col justify-around items-center border-2 rounded-lg relative">
                        <li><input className="styleOfDeliveryForms" type="text" placeholder="Місто" onChange={(e)=> city(e)}/></li>
                        <li><input className="styleOfDeliveryForms" type="text" placeholder="Відділення" onChange={(e)=> branch(e)}/></li>
